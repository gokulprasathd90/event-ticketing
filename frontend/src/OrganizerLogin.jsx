  ...
  return (
    <div style={{ maxWidth: '400px', margin: '0 auto', padding: '2rem' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        >
          {isLoading ? 'Logging in...' : 'Login as Organizer'}
        </button>
      </form>
      <div style={{ marginTop: '1rem', textAlign: 'center' }}>
        <p>Don't have an organizer account? <Link to="/organizer-signup">Sign up here</Link></p>
        <p>Are you a user? <Link to="/user-login">Login as User</Link></p>
      </div>
    </div>
  );
}
